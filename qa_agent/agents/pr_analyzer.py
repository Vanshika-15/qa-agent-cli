...
def run_analyze(description: str, from_git: bool, base: str, save: str, console) -> None:
    """Analyze a PR description, requirement, or git diff and print/save a structured QA report."""
